<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeFile="Scheduler.aspx.cs" Inherits="SchedulerModule" Title="Scheduler" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:ObjectDataSource ID="AppointmentDataSource" runat="server" DataObjectTypeName=" gridviewTest.Model.SchedulerAppointment"
        TypeName=" gridviewTest.Model.AppointmentDataSourceHelper"
    ...
    <asp:ObjectDataSource ID="ResourcesDataSource" runat="server" DataObjectTypeName=" gridviewTest.Model.SchedulerResource"
        TypeName=" gridviewTest.Model.ResourceDataSourceHelper"
